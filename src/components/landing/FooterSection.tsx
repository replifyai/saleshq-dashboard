    ...
    <footer className="py-8 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            <h4 className="font-semibold mb-6 text-lg text-gray-900 dark:text-white">Case Studies</h4>
            <ul className="space-y-3">
              <li><Link href="/case-studies" className="transition-colors text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">All Case Studies</Link></li>
              <li><Link href="/case-studies/ai-powered-enablement-challenges" className="transition-colors text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">AI-Powered Enablement</Link></li>
              <li><Link href="/case-studies/ai-powered-sales-evolution" className="transition-colors text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">Sales Evolution</Link></li>
            </ul>
          </div>
          <div>
