              ...
              <Card className="p-4 md:p-6 lg:p-8 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 border-0 shadow-2xl">
                <div className="relative aspect-video rounded-lg overflow-hidden bg-gray-900">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className={`w-16 h-16 md:w-20 lg:w-24 h-20 lg:h-24 rounded-2xl bg-gradient-to-br ${steps[activeStep].color} flex items-center justify-center animate-pulse`}>
                      <div className="w-8 h-8 md:w-10 lg:w-12 h-10 lg:h-12 text-white">
                  ...
                  <div className="absolute top-2 left-2 md:top-3 lg:top-4 md:left-3 lg:left-4">
                    <Badge className="bg-white/10 backdrop-blur text-white border-0 text-xs">
                  ...
                  <Button 
                    size="icon"
                    variant="ghost"
                    className="absolute bottom-2 right-2 md:bottom-3 lg:bottom-4 md:right-3 lg:right-4 bg-white/10 backdrop-blur hover:bg-white/20 w-8 h-8 md:w-9 lg:w-10 h-9 lg:h-10"
                  >
                    <PlayCircle className="w-4 h-4 md:w-5 lg:w-6 h-5 lg:h-6 text-white" />
                  </Button>
                </div>
