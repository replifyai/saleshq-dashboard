...
export const mockUsers: OrganizationUser[] = [
  {
    id: 'user_001',
    name: 'Emily Foster',
    email: 'emily.foster@replify.com',
    role: 'ceo',
  ...
  },
  {
    id: 'user_002',
    name: 'David Thompson',
    email: 'david.thompson@replify.com',
    role: 'vp',
    title: 'VP of Sales',
    status: 'active',
    joinedAt: '2024-01-01T00:00:00Z',
  ...
  },
  {
    id: 'user_003',
    name: 'Jennifer Wang',
    email: 'jennifer.wang@replify.com',
    role: 'director',
  ...
  },
  {
    ...
    email: 'michael.rodriguez@replify.com',
    role: 'manager',
  ...
  },
  {
    id: 'user_005',
    name: 'Sarah Johnson',
    email: 'sarah.johnson@replify.com',
    role: 'manager',
  ...
  },
  {
    id: 'user_007',
    name: 'Rachel Green',
    email: 'rachel.green@replify.com',
    role: 'manager',
  ...
  },
  {
    id: 'user_010',
    name: 'James Wilson',
    email: 'james.wilson@replify.com',
    role: 'manager',
...
export const mockAvailableUsers: OrganizationUser[] = [
  ...
  },
  {
    id: 'user_012',
    name: 'Amanda Davis',
    email: 'amanda.davis@replify.com',
    role: 'analyst',
    title: 'Sales Analyst',
    status: 'active',
  ...
  },
  {
    ...
    email: 'sophie.martinez@replify.com',
    role: 'member',
...
export const mockOrganizationNodes: OrganizationNode[] = [
  {
    id: 'node_001',
    name: 'Replify Corporation',
    type: 'Company',
    parentId: null,
    level: 0,
    path: 'Replify Corporation',
    order: 0,
    ...
    children: [
      {
        ...
        parentId: 'node_001',
        level: 1,
        path: 'Replify Corporation/Sales Division',
        order: 0,
        ...
        children: [
          {
            ...
            parentId: 'node_002',
            level: 2,
            path: 'Replify Corporation/Sales Division/Enterprise Sales',
            order: 0,
            ...
            children: [
              {
                ...
                parentId: 'node_003',
                level: 3,
                path: 'Replify Corporation/Sales Division/Enterprise Sales/North America Enterprise',
                order: 0,
                ...
                children: [
                  {
                    ...
                    parentId: 'node_004',
                    level: 4,
                    path: 'Replify Corporation/Sales Division/Enterprise Sales/North America Enterprise/Fortune 500 Accounts',
                    order: 0,
                    ...
                    children: [
                      {
                        ...
                        parentId: 'node_005',
                        level: 5,
                        path: 'Replify Corporation/Sales Division/Enterprise Sales/North America Enterprise/Fortune 500 Accounts/Tech Sector Focus',
                        order: 0,
          ...
          },
          {
            ...
            parentId: 'node_002',
            level: 2,
            path: 'Replify Corporation/Sales Division/SMB Sales',
            order: 1,
      ...
      },
      {
        ...
        parentId: 'node_001',
        level: 1,
        path: 'Replify Corporation/Engineering Division',
        order: 1,
